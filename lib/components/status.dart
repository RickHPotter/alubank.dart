      ...
      child: Column(
        ...
        children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          color: ThemeColours.recentActivity['outcome']),
                    ),
                  ),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                ...
                children: [
                  Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(5),
                          color: ThemeColours.recentActivity['income']),
                    ),
                  ),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
          ...
          Column(
            ...
            children: <Widget>[
              Text(
                'This month you spent ${spentAndEarned()} % of your money. Work on turning down this number!',
              ),
              TextButton(
